...
module.exports = () => {
  ...
  setup(
    ...
    '# Double Take\n# Learn more at https://github.com/giuseppe99barchetta/double-take/#configuration'
  );
  setup(
    `secrets.${SYSTEM_CORE.storage.secrets.extension}`,
    SYSTEM_CORE.storage.secrets.path,
    '# Use this file to store secrets like usernames and passwords\n# Learn more at https://github.com/giuseppe99barchetta/double-take/#storing-secrets\nsome_password: welcome'
  );
